...
**I turn models into usable software**
...
AI/ML/DS
- 🦞 **[OpenClaw Job Vault](https://github.com/boyeaalhagie/openclaw_job_vault)** *(in progress)*  - AI agent that saves job postings after you apply to them.
